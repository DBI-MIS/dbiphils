<div class="flex flex-col md:flex-row md:items-center items-start gap-5 w-full justify-between py-4 px-5 md:px-10  bg-white/50 rounded-lg" data-nosnippet>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2">
        <div class="flex flex-row items-center gap-2">
              ...
              <span>Follow, Like & Subscribe: </span>
        </div>
    ...
    <div class="flex gap-1 mt-1 items-center">
        ...
        <div>
            <a href="https://www.linkedin.com/company/db-international-sales?originalSubdomain=ph" target="_blank" rel="noopener noreferrer">DBInternational</a></div> 
        </div>
    </div>
