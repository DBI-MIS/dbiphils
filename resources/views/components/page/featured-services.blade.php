@props(['service'])
<div class="rounded-xl border border-opacity-10 shadow-lg bg-white hover:bg-gray-100 border-blue-800 col-span-1 aspect-square items-center p-7 text-balance justify-center flex flex-col min-w-60 min-h-60 cursor-pointer hover:scale-110 hover:z-50 transition-transform">
        ...
        <div class="flex flex-col gap-1 text-center">
            ...
            <span class="text-pretty leading-tight text-xs">{!! $service->description !!}</span>
