@props(['testimonial'])
<div class="rounded-xl border border-opacity-10 shadow-lg bg-white hover:bg-gray-100 border-blue-800 col-span-1 overflow-hidden cursor-pointer hover:scale-110 hover:z-50 transition-transform">
    <div class="text-balance flex flex-col">
        ...
        <div class="flex flex-col gap-2 px-10 py-4 text-center">
            ...
            <button class="mx-auto text-base font-light rounded-xl px-2 py-1 text-white bg-blue-800 pointer-events-none leading-tight mb-4">{{ $testimonial->personnel }}</button>
