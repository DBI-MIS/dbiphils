...
@section('structuredData')
    ...
    <article class="col-span-8 md:col-span-3 md:mt-8 mx-auto w-full h-full py-4" style="max-width:900px">
            ...
            <div class="w-full py-6">
                ...
                <h3 class="text-3xl md:text-4xl font-bold text-left text-gray-800">
                    {{ $post->title }}
                </h3>
        ...
        <div class="flex flex-col md:flex-row md:items-center items-start gap-5 w-full justify-between py-4 px-5 md:px-10 border-y-2 border-blue-200" data-nosnippet>
